...
class KeywordsSubtopic2 extends DatabaseObject {
    
    protected static $table_name = "keywords_subtopic2";
    protected static $db_fields = array('id', 'sub_topic_2_id', 'keywords');
    
    public $id;
    public $sub_topic_2_id;
    public $keywords;
...
} // end of KeywordsSubtopic2 class
