...
class KeywordsSubtopic1 extends DatabaseObject {
    
    protected static $table_name = "keywords_subtopic1";
    protected static $db_fields = array('id', 'sub_topic_1_id', 'keywords');
...
} // end of KeywordsSubtopic1 class
