...
class KeywordsTopic extends DatabaseObject {
    
    protected static $table_name = "keywords_topics";
    protected static $db_fields = array('id', 'topic_id', 'keywords');
