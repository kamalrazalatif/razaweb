...
class KeywordsCategory extends DatabaseObject {
    
    protected static $table_name = "keywords_category";
    protected static $db_fields = array('id', 'category_id', 'keywords');
