...
class KeywordsSubtopic4 extends DatabaseObject {
    
    protected static $table_name = "keywords_subtopic4";
    protected static $db_fields = array('id', 'sub_topic_4_id', 'keywords');
    
    public $id;
    public $sub_topic_4_id;
    public $keywords;
...
} // end of KeywordsSubtopic4 class
