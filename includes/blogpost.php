...
class BlogPost extends DatabaseObject {
    
    protected static $table_name = "blog_posts";
    protected static $db_fields = array('id', 'user_id','portal_id','topic_id','post_pic','post_content','post_date');
