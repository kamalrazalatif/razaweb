...
class SubTopic1 extends DatabaseObject {
    
    protected static $table_name = "sub_topic_1";
    protected static $db_fields = array('id', 'sub_topic_1', 'topic_id');
