...
class SubTopic2 extends DatabaseObject {
    
    protected static $table_name = "sub_topic_2";
    protected static $db_fields = array('id', 'sub_topic_2', 'sub_topic_1_id','genre_id','sub_topic_2_pic');
    
    public $id;
    public $sub_topic_2;
    public $sub_topic_1_id;
    public $genre_id;
    public $sub_topic_2_pic;
