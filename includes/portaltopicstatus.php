...
class PortalTopicStatus extends DatabaseObject {
    
    protected static $table_name = "portal_topic_status";
    protected static $db_fields = array('portal_id', 'topic_status_id');
    
    public $portal_id;
    public $topic_status_id;
...
} // end of PortalTopicStatus class
