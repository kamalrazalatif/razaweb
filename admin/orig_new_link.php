...
$sub_category_1_id = !empty($_POST['sub_category_1_id']) ? $_POST['sub_category_1_id'] : 0;
$content_source_id = $_POST['content_source_id'];
$rank = 0;
$toplinks = 0;
$quicklink = !empty($_POST['quicklink']) ? $_POST['quicklink'] : 0;
...
// SQL Query:
$query = "INSERT INTO links (user_id,portal_id,topic_id,sub_topic_1_id,sub_topic_2_id,sub_topic_3_id,sub_topic_4_id,category_id,sub_category_1_id,content_source_id,rank,toplinks,quicklink,link_text,link_href,link_desc,link_pic,link_date,upload_date)
                    VALUES ({$user_id},{$portal_id},{$topic_id},{$sub_topic_1_id},{$sub_topic_2_id},{$sub_topic_3_id},{$sub_topic_4_id},{$category_id},{$sub_category_1_id},{$content_source_id},{$rank},{$toplinks},{$quicklink},'{$link_text}','{$link_href}','{$link_desc}','{$upload_filename}','{$link_date}','{$upload_date}')";
