    ...
    <div class="container main-container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <?php if($portal_id != 156){
                    while($topic_data = mysqli_fetch_assoc($topic_result)){
                        ...
                        $output = "<li><a href=\"index.php?p={$portal_id}&amp;t={$topic_id}\">{$topic_title}</a></li>";
                        echo $output;
                    }
                }
                ?>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="index.html"><span class="glyphicon glyphicon-home"></span>Culture Home</a> | </li>
                        <li><a href="TV/index.html">TV</a> | </li> 
                        <li><a href="Films/index.html">Film</a> | </li> 
                        ...
                        <li><a href="theatre/index.html">Theatre</a> | </li>
                        <li><a href="events/index.html">Events by Location</a></li> 
                    <!-- end navbar nav --></ul>
        <!-- end row 2 --></div>   
        ...
        <div class="row">
            <ol class="breadcrumb">
              ...
              <li><a href="#">Culture</a> <span class="glyphicon glyphicon-circle-arrow-right"></span></li>
